...
AWC_HEADERS="AIMP2_SDK.h CRC32.h dealer.h Responder.h simpleserver.h"
AWC_SOURCES="dllmain.cpp AIMP2WebControlHeader.hpp simpleserver.cpp dealer.cpp Responder.cpp CRC32.cpp MultiReaderSingleWriter.hpp"
